            ...
            <section>
                <div className='container'>
                    <div className='bg-gold p-0.5 rounded-xl'>
                        <div className='bg-gray-150 p-10 rounded-xl'>
                            <h2 className='text-center'>
                                {t('yachts-descriptor.title')}
                            </h2>
                        </div>
                    </div>
             ...
             <section>
                <div className='container'>
                    <h2 className='text-center max-w-xl mx-auto'>
                        {t('yachts-why-us.title')}
                    </h2>
                    <p className='text-center max-w-xl mx-auto py-4'>
                        {t('yachts-why-us.description')}
                    </p>
                    <div
                        className='bg-cover bg-center bg-no-repeat h-40 rounded-xl my-10'
