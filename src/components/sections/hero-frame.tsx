 ...
 * where the words sit in the screen and whether the screen holds a photograph or a film.
 */
...
/** The screen-filling photograph, for the heroes drawn on one rather than on a film. */
...
export function HeroFrame({
  ...
  /** What fills the screen behind the words: a photograph, or the film of the home page. */
  backdrop: ReactNode
