...
| Dead `aircraft/old.tsx`, `app/actions.ts`                                                                                          | §2.1, §8.6                        | E6.23 (decided: not ported; the old layout's look is E8.4)                                                                 |
| **Chrome**                                                                                                                         |                                   |                                                                                                                            |
