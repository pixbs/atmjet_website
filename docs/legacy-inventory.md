...
| `loading.tsx`, missing `not-found`/`error`/`privacy`                                                                               | §2.5                              | E3.10; E3.11 [D]                                                                                                           |
