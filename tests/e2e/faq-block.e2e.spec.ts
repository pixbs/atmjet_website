...
/**
 * The FAQ as a block (issue #123, `docs/legacy-inventory.md` section 5). The questions and
 * answers come from the document and are in the markup before any script runs; the accordion
 * decides which answer is showing.
 *
